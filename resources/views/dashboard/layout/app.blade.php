...
<head>
    ...
    <link rel="stylesheet" href="dashboard/css/responsive.css">
     <!-- Start datatable css -->
    <link rel="stylesheet" href="dashboard/css/datatable.css">
...
<body>
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="{{url('/')}}"><img src="dashboard/images/icon/logo.png" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="">
                                <a href="{{route('admins.index')}}" aria-expanded="true"><i class="ti-user"></i><span>Admins</span></a>
                            </li>
                            <li class="">
                                <a href="{{route('posts.index')}}" aria-expanded="true"><i class="ti-book"></i><span>Posts</span></a>
                            </li>
                            <li class="">
                                <a href="{{route('works.index')}}" aria-expanded="true"><i class="ti-gears"></i><span>Projects</span></a>
                            </li>
                            <li class="">
                                <a href="{{route('contacts.index')}}" aria-expanded="true"><i class="ti-headphone-alt"></i><span>Contact Messages</span></a>
                            </li>
 ...
 <div class="main-content">
                                    ...
                                    <div class="nofity-list">
                                        <a href="#" class="notify-item">
                                            <div class="notify-thumb">
                                                <img src="dashboard/images/author/author-img1.jpg" alt="image">
                                            </div>
                                            <div class="notify-text">
                                                <p>Aglae Mayer</p>
                                        ...
                                        <a href="#" class="notify-item">
                                            <div class="notify-thumb">
                                                <img src="dashboard/images/author/author-img2.jpg" alt="image">
                                            </div>
                                            <div class="notify-text">
                                                <p>Aglae Mayer</p>
                                        ...
                                        <a href="#" class="notify-item">
                                            <div class="notify-thumb">
                                                <img src="dashboard/images/author/author-img3.jpg" alt="image">
                                            </div>
                                            <div class="notify-text">
                                                <p>Aglae Mayer</p>
                                        ...
                                        <a href="#" class="notify-item">
                                            <div class="notify-thumb">
                                                <img src="dashboard/images/author/author-img4.jpg" alt="image">
                                            </div>
                                            <div class="notify-text">
                                                <p>Aglae Mayer</p>
    ...
    <script src="dashboard/js/line-chart.js"></script>
    <!-- all pie chart -->
    <script src="dashboard/js/pie-chart.js"></script>
    <!-- others plugins -->
